...
![img alt](https://github.com/ComputerScienceHayk/flutter_painter/blob/master/screen.gif)
...
Use the package [https://pub.dev/packages/painter](https://pub.dev/packages/painter) 
